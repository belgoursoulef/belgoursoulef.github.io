...
data = {
    ...
    "AC12.05": {
        "fr": {
            ...
            "Comment je l’ai fait (méthode, outils, ressources) :": "J'ai pu mettre cela en pratique lors de mon expérience avec le programme World Learning (à l'American Corner), où j'ai animé des ateliers STEM. En enseignant le codage et l'automatisation à des apprenants novices, j'ai dû apprendre à vulgariser des concepts techniques. C'est à travers cette démarche pédagogique que j'ai développé ma capacité à remplacer le jargon complexe par des mots familiers, afin de rendre des notions informatiques pointues totalement accessibles à mon audience.",
        ...
        "en": {
            ...
            "How I did it (method, tools, resources):": "I was able to put this into practice during my experience with the World Learning program (at the American Corner), where I facilitated STEM workshops. By teaching coding and automation to novice learners, I had to learn how to simplify technical concepts. It was through this pedagogical approach that I developed my ability to replace complex jargon with familiar terms, making advanced computer science concepts fully accessible to my audience.",
